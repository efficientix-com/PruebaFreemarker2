                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <span><img src="${infoEmpresa.logo@url}"/></span>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
                                                ...
                                                <#if Conceptos.Impuestos.Traslados.Traslado?is_sequence>
                                                    <#list Conceptos.Impuestos.Traslados.Traslado as traslado_imp>
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${traslado_imp.atributos.Importe}</td>
                                                        </tr>
                                                    </#list>
                                                <#else>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${Conceptos.Impuestos.Traslados.Traslado.atributos.Importe}</td>
                                                    </tr>
                                                </#if>
                                            </#if>
                                                ...
                                                <#if Conceptos.Impuestos.Retenciones.Retencion?is_sequence>
                                                    <#list Conceptos.Impuestos.Retenciones.Retencion as ret_imp>
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="4"
                                                                style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${ret_imp.atributos.Importe}</td>
                                                        </tr>
                                                    </#list>
                                                <#else>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${Conceptos.Impuestos.Retenciones.Retencion.atributos.Importe}</td>
                                                    </tr>
                                                </#if>
                                            </#if>
                                        </table>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                                        ...
                                        <td colspan="18" style="border-left: 1px; border-color: #e3e3e3;">
                                            ...
                                            <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                                ...
                                                <#if desglose.ieps.name?has_content>
                                                    <tr>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${desglose.ieps.base_importe}</td>
                                                        <td align="left" colspan="4"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.importe)}</td>
                                                    </tr>
                                                </#if>
                                                ...
                                                <#if desglose.iva.name?has_content>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.base_importe) }</td>
                                                        <td align="left" colspan="4"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${ nsformat_rate(desglose.iva.rate)} %
                                                        </td>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">${ nsformat_rate(desglose.iva.importe)?keep_after('$')}</td>
                                                    </tr>
                                                </#if>
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${ nsformat_rate(item.rate)}</td>
                            <td align="center" colspan="4"
                            ...
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${importe_discount[item_index+1]}</td>
                            <#assign "descuento_total" = descuento_total + importe_discount[item_index+1]>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${ nsformat_rate(item.grossamt)}</td>
                        </#if>
                    </tr>
    ...
    <#if desglose_json_body?has_content>
        ...
        <#assign "desglose_iva" = desglose_body.rates_iva>
        <#assign "desglose_ret" = desglose_body.rates_retencion>
        <#assign "retencion_total" = desglose_body.retencion_total>
            ...
            <td colspan="2" style="margin: 0px; padding: 0;">
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                        ...
                        <#else>
                            <#if record.custbody_efx_fe_gbl_subtotal?has_content>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${ nsformat_rate(record.custbody_efx_fe_gbl_subtotal)}</td>
                            <#else>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${ nsformat_rate(record.subtotal)}</td>
                            </#if>
                        </#if>
                    ...
                    <tr>
                        ...
                        <#else>
                            <#if descuento_total != 0>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;"><#if desglose_total_discount?has_content>${nsformat_rate(desglose_total_discount)}</#if></td>
                            <#else>
                                <#if record.discounttotal != 0>
                                    <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(record.discounttotal)}</td>
                                <#else>
                    ...
                    <tr>
                        ...
                        <#else>
                            <#assign totalivaGBL = local_total?number + iva_total?number + ieps_total?number>
                            <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(totalivaGBL) }</td>
                        </#if>
                    </tr>
                    <#if dataXML?has_content>
                            ...
                            <#list dataXML.Impuestos.Traslados.Traslado as traslados_lista>
                                ...
                                <tr>
                                    <td colspan="2" style="font-size: 5pt;">
                                        ${iva_ratenum}%: ${traslados_lista.atributos.Importe}<br/>
                                    </td>
                                </tr>
                            </#list>
                        <#else>
                            ...
                            <tr>
                                <td colspan="2" style="font-size: 5pt;">
                                    ${iva_ratenum}%: ${dataXML.Impuestos.Traslados.Traslado.atributos.Importe}<br/>
                                </td>
                            </tr>
                        </#if>
                    ...
                    <#else>
                        <#list obj_totales_imp as Iva_rate, Iva_total>
                            ...
                            <#if Iva_rate == "16" || Iva_rate == "0">
                                <tr>
                                    <td colspan="2" style="font-size: 5pt;">
                                        ${Iva_rate}%: ${nsformat_rate(Iva_total)}<br/>
                                    </td>
                                </tr>
                            </#if>
                        </#list>
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;">${nsformat_rate(retencion_total)}</td>
                        </#if>
                    </tr>
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;"><#if cabecera_total?has_content>${nsformat_rate(cabecera_total)}</#if></td>
                        </#if>
